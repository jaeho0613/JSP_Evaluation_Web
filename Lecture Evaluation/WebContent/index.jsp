...
<body>
	...
	<section class="container">
		<form action="get" action="./index.jsp" class="form-inline mt-3">
			...
			<button type="button" class="btn btn-primary mx-1 mt-2" data-toggle="modal" data-target="#registerModal">등록하기</button>
			<button type="button" class="btn btn-danger mx-1 mt-2"	data-toggle="modal" data-target="#reportModal">신고하기</button>
		</form>
<%
