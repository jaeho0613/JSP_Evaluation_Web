...
<body>
	...
	<section class="container">
		<form action="get" action="./index.jsp" class="form-inline mt-3">
			...
			<button type="button" class="btn btn-primary mx-1 mt-2" data-toggle="modal"
				data-target="#registerModal">등록하기</button>
			<button type="button" class="btn btn-danger mx-1 mt-2" data-toggle="modal"
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				...
				<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운건 없지만 학점도 잘 나오고 너무 좋은
					것 같습니다.</p>
				<div class="row">
					...
					<div class="col-3 text-right">
						<a onclick="return confirm('추천하시겠습니까?')" href="./likeAction.jsp?evaluationID=">추천</a> <a
							onclick="return confirm('삭제하시겠습니까?')" href="./deleteAction.jsp?evaluationID=">삭제</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					괜찮은 거 같습니다.&nbsp;<small>(2017년 1학기)</small>
				</h5>
				<p class="card-text">알고리즘을 잘 몰랐는데 강의를 듣고 많이 좋아졌습니다.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span> 널널<span style="color: red;">B</span>
