...
<body>
  ...
  <section class="container">
    <form action="get" action="./index.jsp" class="form-inline mt-3">
      <select name="letureDivide" id="" class="form-control mx-1 mt-2">
      ...
      <button type="button" class="btn btn-primary mx-1 mt-2" data-toggle="modal" data-target="#registerModal">
        등록하기
      </button>
      <button type="button" class="btn btn-danger mx-1 mt-2" data-toggle="modal" data-target="#reportModal">
        신고하기
      </button>
    </form>
    ...
    <div class="card bg-light mt-3">
      <div class="card-header bg-light">
        <div class="row">
          ...
          <div class="col-4 text-left">종합<span style="color: red;">A</span></div>
        </div>
      </div>
      <div class="card-body">
        <h5 class="card-title">정말 좋은 강의에요.&nbsp;<small>(2017년 가을학기)</small></h5>
        <p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운건 없지만 학점도 잘 나오고 너무 좋은 것 같습니다.</p>
        <div class="row">
    ...
    <div class="card bg-light mt-3">
      <div class="card-header bg-light">
        <div class="row">
          ...
          <div class="col-4 text-left">종합<span style="color: red;">B</span></div>
        </div>
      </div>
      <div class="card-body">
        <h5 class="card-title">나쁘지 않은 것 같습니다.&nbsp;<small>(2017년 여름학기)</small></h5>
    ...
    <div class="card bg-light mt-3">
      <div class="card-header bg-light">
        <div class="row">
          ...
          <div class="col-4 text-left">종합<span style="color: red;"></span></div>
        </div>
      </div>
      <div class="card-body">
        <h5 class="card-title">괜찮은 거 같습니다.&nbsp;<small>(2017년 1학기)</small></h5>
        <p class="card-text">알고리즘을 잘 몰랐는데 강의를 듣고 많이 좋아졌습니다.</p>
        <div class="row">
          <div class="col-9 text-left">
            성적<span style="color: red;">A</span>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="./reportAction.jsp" method="post">
            ...
            <div class="form-group">
              <label>신고 내용</label>
              <textarea name="reprotContent" class="form-control" maxlength="2048" style="height: 180px;"></textarea>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">취소</button>
